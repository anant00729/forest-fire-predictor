...
def main(keyspace, table):
  ...
  df = df.select('fire_cause', 'year', 'objectid')


  df = df.groupBy('fire_cause', 'year').count()
...
if __name__ == '__main__':
    keyspace = 'asa404'
    table = 'his_year_fire_cause_vs_count'
    main(keyspace, table)
