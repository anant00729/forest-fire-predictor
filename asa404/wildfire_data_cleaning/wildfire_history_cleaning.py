...
def main(input, output):
  ...
  df.repartition(500).write.csv(output, header='true', mode='append')
...
# spark-submit  --deploy-mode client --driver-memory 12G --num-executors=8 wildfire_history_cleaning.py /Users/anantsawasthy/Documents/ReactWorkspace/leaflet/map_single_sample.json oo-1
